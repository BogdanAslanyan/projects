...
Suite *suite_truncate(void) {
  ...
  tcase_add_test(tc, truncate_test_17);
  tcase_add_test(tc, truncate_test_18);
  tcase_add_test(tc, truncate_test_19);
  tcase_add_test(tc, truncate_test_20);
  tcase_add_test(tc, truncate_test_21);
  tcase_add_test(tc, truncate_test_22);
  tcase_add_test(tc, truncate_test_23);
