...
START_TEST(floor_test_14) {
  // 7130
  s21_decimal src1, origin, result = {{0, 0, 0, 0}, 0};
  // src1 = 2;
...
Suite *suite_floor(void) {
  ...
  tcase_add_test(tc, floor_test_22);
  tcase_add_test(tc, floor_test_23);
  tcase_add_test(tc, floor_test_24);
