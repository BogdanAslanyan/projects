...
START_TEST(from_int_to_decimal_test_3) {
  ...
  add = s21_from_int_to_decimal(a, ptr_b);  // a записываем в b
  s21_decimal etalon = {{1000, 0, 0, 0}, 0};
  ck_assert_int_eq(add, CONVERTERS_S21_TRUE);
...
START_TEST(from_int_to_decimal_test_4) {
  ...
  add = s21_from_int_to_decimal(a, ptr_b);  // a записываем в b
  s21_decimal etalon = {{INT_MAX, 0, 0, 0}, 0};
  ck_assert_int_eq(add, CONVERTERS_S21_TRUE);
  // выходное значение s21_from_int_to_decimal -
  // 0 TRUE и 1 FALSE
  // s21_is_equal Возвращаемое значение: 0 - FALSE 1 - TRUE
...
START_TEST(from_int_to_decimal_test_5) {
  ...
  add = s21_from_int_to_decimal(a, ptr_b);  // a записываем в b
  s21_decimal etalon = {{INT_MAX, 0, 0, 2147483648}, 0};
  ck_assert_int_eq(add, CONVERTERS_S21_TRUE);
  // выходное значение s21_from_int_to_decimal -
  // 0 TRUE и 1 FALSE
  // s21_is_equal Возвращаемое значение: 0 - FALSE 1 - TRUE
...
START_TEST(from_int_to_decimal_test_6) {
  ...
  add = s21_from_int_to_decimal(a, ptr_b);  // a записываем в b
  s21_decimal etalon = {{INT_MAX, 0, 0, ~(INT_MAX)}, 0};
  ck_assert_int_eq(add, CONVERTERS_S21_TRUE);
  // выходное значение s21_from_int_to_decimal -
  // 0 TRUE и 1 FALSE
  // s21_is_equal Возвращаемое значение: 0 - FALSE 1 - TRUE
...
START_TEST(from_int_to_decimal_test_11) {
  // 6428
  int src1 = -1;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_12) {
  // 6444
  int src1 = 0;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_13) {
  // 6460
  int src1 = 0;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_14) {
  // 6476
  int src1 = -987879878;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_15) {
  // 6492
  int src1 = -2147483646;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_16) {
  // 6508
  int src1 = 2147483646;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_17) {
  // 6524
  int src1 = 796132784;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
START_TEST(from_int_to_decimal_test_18) {
  // 6540
  int src1 = -12345677;
  s21_decimal origin, result;
  s21_decimal *res = &result;
...
Suite *suite_from_int_to_decimal(void) {
  ...
  tcase_add_test(tc, from_int_to_decimal_test_11);
  tcase_add_test(tc, from_int_to_decimal_test_12);
  tcase_add_test(tc, from_int_to_decimal_test_13);
  tcase_add_test(tc, from_int_to_decimal_test_14);
  tcase_add_test(tc, from_int_to_decimal_test_15);
  tcase_add_test(tc, from_int_to_decimal_test_16);
  tcase_add_test(tc, from_int_to_decimal_test_17);
  tcase_add_test(tc, from_int_to_decimal_test_18);
